<nav id="myNavbar" class="navbar navbar-default navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="container">
        <div class="navbar-header">
			...
			<span class="glyphicon glyphicon-th-large"></span> SOSMED GADUNGAN <span class="glyphicon glyphicon-th-large"></span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown"><a data-toggle="dropdown" class="dropdown-toggle" href="#">
									 <span class="glyphicon glyphicon-exclamation-sign" title="Notifikasi"></span></a>
                ...
                <li><a href = "profil.php?id=<?php echo "$_SESSION[id]";?>">
				    <span class="glyphicon glyphicon-user"></span><?php echo ' '.$nama;?></a></li>
                <li class="active"><a href = "home.php?id=<?php echo "$_SESSION[id]";?>"><span class="glyphicon glyphicon-log-out"></span> HOME</a></li>
